...
export default async function Home() {
  ...
  return <main className="home-page">
    ...
    <section className="home-hero">
      ...
      {invitations.length > 0 && <Link className="primary-link" href="#bo-suu-tap">Xem thiệp mẫu <ArrowUpRight size={18} /></Link>}
      <div className="home-mark" aria-hidden="true"><Heart size={18} strokeWidth={1} /></div>
    </section>
    <section id="bo-suu-tap" className="home-collection" aria-labelledby="collection-title">
      ...
      })}</div> : <p className="empty-home">Chưa có thiệp nào được xuất bản.</p>}
    </section>
